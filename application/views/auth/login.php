...
<body>
<div class="login-box">
<h1><i class='fa fa-bookmark'></i>&nbsp;Welcome To Cascade </h1><hr>
<div class="input-box">
      <div class="row">
...
<?php
  ...
  <div class="input-group form-group">
    <div class="">
    <?php $data = array('name' => 'submit','value' => lang('login_submit_btn'),'id' => 'btnSubmit','class' => 'btn  btn-primary  btn-submit pull-right');  echo form_submit($data);?>
    </div>
  </div>
<?php echo form_close();?>
<div class="input-group form-group">
