	...
	<div class="col-md-12">
          ...
          <div class="panel">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-6">
                  <form action="<?php echo base_url('index.php').'/admin_client/save_client_area_news'; ?>" method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input class="datepicker form-control" name="publish_date" id="publish_date" data-date-format="mm/dd/yyyy">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <textarea name="news_item" id="news_item" class="summernote drp-s"></textarea>
                      </div>
                    </div>
                    <div class="form-group">
