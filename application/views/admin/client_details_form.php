	...
	<div class="col-md-12">
		<div class="panel">
		  	...
		  	<div class="panel-body">
				<p class='text-default'><b>Edit Client Details</b></p>
				<div class="col-md-5">
					<div class="table-responsive">
						<table class="table">
							<tbody>
								<tr>
									<td class='active col-md-6'>Last Logged In:</td>
									<td><?php echo date('D , d M Y',$client_info->last_logged); ?></td>
								</tr>
								<tr>
									<td class='active col-md-6'>Last Logged in From:</td>
									<td><?php echo '[ '.$client_info->logged_ip.' ]'.br(1).'[ '.$client_info->logged_host.' ]'; ?></td>
								</tr>
								<tr>
									<td class='active col-md-6'>Accessible Profiles:</td>
									<td>need work</td>
								</tr>
								<tr>
									<td class='active col-md-6'>First Name:</td>
									<td>
										<?php
								...
								<tr>
									<td class='active col-md-6'>Last Name:</td>
									<td>
										<?php
								...
								<tr>
									<td class='active col-md-6'>Organization:</td>
									<td>
										<?php
								...
								<tr>
									<td class='active col-md-6'>Address:</td>
									<td>
										<?php
								...
								<tr>
									<td class='active col-md-6'>City:</td>
									<td>
										<?php
								...
								<tr>
									<td class='active col-md-6'>USA State:</td>
									<td>
								...
								<tr>
									<td class='active col-md-6'>Non USA Province:</td>
									<td>
										<?php
								...
								<tr>
									<td class='active col-md-6'>ZIP / Postal Code:</td>
									<td>
										<?php
								...
								<tr>
									<td class='active col-md-6'>Country:</td>
									<td>
										<?php
											$country = array(
												"" => "Select Country",
						 					...
						 					echo form_dropdown('reg_country', $country, $client_info->country, 'class="form-control drp"'); 
