<div class="row">
	<div class="col-md-12">
		...
		<div style="text-align:right">
			<a class="btn btn-success" href="<?php echo site_url($this->config->item('admin_folder').'/categories/form'); ?>"><i class="icon-plus-sign"></i> <?php echo lang('add_new_category');?></a>
		</div>
		<br>
		<div class="panel">
