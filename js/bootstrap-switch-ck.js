        ...
        var n = {
            init: function() {
                return this.each(function() {
                    var t = e(this), n, r, i, s, o = "", u = t.attr("class"), a, f, l = "ON", c = "OFF", h = !1;
                    e.each([ "switch-mini", "switch-small", "switch-large" ], function(e, t) {
                        u.indexOf(t) >= 0 && (o = t);
                    });
                    t.addClass("has-switch");
                    t.data("on") !== undefined && (a = "switch-" + t.data("on"));
                    t.data("on-label") !== undefined && (l = t.data("on-label"));
                    t.data("off-label") !== undefined && (c = t.data("off-label"));
                    t.data("icon") !== undefined && (h = t.data("icon"));
                    r = e("<span>").addClass("switch-left").addClass(o).addClass(a).html(l);
                    a = "";
                    t.data("off") !== undefined && (a = "switch-" + t.data("off"));
                    i = e("<span>").addClass("switch-right").addClass(o).addClass(a).html(c);
                    s = e("<label>").html("&nbsp;").addClass(o).attr("for", t.find("input").attr("id"));
                    h && s.html('<i class="' + h + '"></i>');
                    n = t.find(":checkbox").wrap(e("<div>")).parent().data("animated", !1);
                    t.data("animated") !== !1 && n.addClass("switch-animate").data("animated", !0);
                    n.append(r).append(s).append(i);
                    t.find(">div").addClass(t.find("input").is(":checked") ? "switch-on" : "switch-off");
                    t.find("input").is(":disabled") && e(this).addClass("deactivate");
                    var p = function(e) {
                    ...
                    t.find("input").on("change", function(t) {
                        var n = e(this), r = n.parent(), i = n.is(":checked"), s = r.is(".switch-off");
                        t.preventDefault();
                        r.css("left", "");
                        if (s === i) {
                            i ? r.removeClass("switch-off").addClass("switch-on") : r.removeClass("switch-on").addClass("switch-off");
                            r.data("animated") !== !1 && r.addClass("switch-animate");
                            r.parent().trigger("switch-change", {
                                el: n,
                                value: i
                            });
                        }
                    ...
                    t.find("label").on("mousedown touchstart", function(t) {
                        ...
                        if (n.closest(".has-switch").is(".deactivate")) n.unbind("click"); else {
                            ...
                            n.on("click touchend", function(t) {
                                ...
                                t.preventDefault();
                                n.unbind("mouseleave");
                                f ? i.prop("checked", !(parseInt(n.parent().css("left")) < -25)) : i.prop("checked", !i.is(":checked"));
                                f = !1;
                                i.trigger("change");
                            });
