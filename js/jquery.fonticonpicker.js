    ...
    Plugin.prototype = {
        ...
        renderIconContainer: function () {
            ...
            if (this.settings.emptyIcon) {
                ...
                this.iconContainer.html('<span class="fip-box"><i class="fa fa-user"></i></span>');

            // If not show an error when no icons are found
            } else if (iconsPaged.length < 1) {
                this.iconContainer.html('<span class="icons-picker-error"><i class="fa fa-user"></i></span>');
                return;
        ...
        setSelectedIcon: function (theIcon) {
            ...
            this.iconPicker.find('.selected-icon').html('<i class="' + (theIcon || 'fa fa-maxcdn') + '"></i>');
        ...
        toggleIconSelector: function () {
            ...
            this.iconPicker.find('.selector-button i').toggleClass('fa fa-caret-down');
            this.iconPicker.find('.selector-button i').toggleClass('fa fa-caret-down');
            if (this.open) {
