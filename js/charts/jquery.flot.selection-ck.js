...
- getSelection()
  ...
  */(function(e) {
    function t(t) {
        ...
        function u(e) {
            i = null;
            document.onselectstart !== undefined && (document.onselectstart = r.onselectstart);
            document.ondrag !== undefined && (document.ondrag = r.ondrag);
            n.active = !1;
            h(e);
            if (m()) f(); else {
        ...
        function a() {
            ...
            var r = {}, i = n.first, s = n.second;
            e.each(t.getAxes(), function(e, t) {
                if (t.used) {
                    var n = t.c2p(i[t.direction]), o = t.c2p(s[t.direction]);
                    r[e] = {
                        from: Math.min(n, o),
                        to: Math.max(n, o)
                    };
        ...
        function f() {
            ...
            e.xaxis && e.yaxis && t.getPlaceholder().trigger("selected", [ {
                x1: e.xaxis.from,
                y1: e.yaxis.from,
                x2: e.xaxis.to,
                y2: e.yaxis.to
        ...
        function c(e, r) {
            var i = t.getOptions(), s = t.getPlaceholder().offset(), o = t.getPlotOffset();
            e.x = l(0, r.pageX - s.left - o.left, t.width());
            e.y = l(0, r.pageY - s.top - o.top, t.height());
            i.selection.mode == "y" && (e.x = e == n.first ? 0 : t.width());
            i.selection.mode == "x" && (e.y = e == n.first ? 0 : t.height());
        }
        function h(e) {
        ...
        function p(e) {
            if (n.show) {
                n.show = !1;
                t.triggerRedrawOverlay();
                e || t.getPlaceholder().trigger("plotunselected", []);
            }
        }
        function d(e, n) {
            var r, i, s, o, u = t.getAxes();
            for (var a in u) {
                r = u[a];
                if (r.direction == n) {
                    o = n + r.n + "axis";
        ...
        function m() {
            ...
            return Math.abs(n.second.x - n.first.x) >= e && Math.abs(n.second.y - n.first.y) >= e;
        }
        var n = {
            first: {
                x: -1,
        ...
        t.hooks.drawOverlay.push(function(t, r) {
            if (n.show && m()) {
                var i = t.getPlotOffset(), s = t.getOptions();
                r.save();
                r.translate(i.left, i.top);
                var o = e.color.parse(s.selection.color);
                r.strokeStyle = o.scale("a", .8).toString();
                r.lineWidth = 1;
                r.lineJoin = s.selection.shape;
                r.fillStyle = o.scale("a", .4).toString();
                var u = Math.min(n.first.x, n.second.x) + .5, a = Math.min(n.first.y, n.second.y) + .5, f = Math.abs(n.second.x - n.first.x) - 1, l = Math.abs(n.second.y - n.first.y) - 1;
                r.fillRect(u, a, f, l);
