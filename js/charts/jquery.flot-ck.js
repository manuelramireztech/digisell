...
(function(e) {
    ...
    function r(t, r, s, o) {
        ...
        function x(n) {
            ...
            for (r = 0; r < s; ++r) {
                ...
                i = e.extend(!0, {}, a.xaxis, i);
                a.xaxes[r] = i;
                if (i.font) {
                    i.font = e.extend({}, o, i.font);
            ...
            if (a.x2axis) {
                a.xaxes[1] = e.extend(!0, {}, a.xaxis, a.x2axis);
                a.xaxes[1].position = "top";
            }
            if (a.y2axis) {
                a.yaxes[1] = e.extend(!0, {}, a.yaxis, a.y2axis);
        ...
        function M() {
            ...
            for (r = 0; r < u.length; ++r) {
                ...
                if (p.color == null) {
                    ...
                    ++h;
                } else typeof p.color == "number" && (p.color = o[p.color].toString());
                ...
                for (s = o = 0; s < w.length; ++s, o += h) {
                    ...
                    if (!C) for (a = 0; a < h; ++a) {
                        ...
                        if (g) {
                            if (g.number && m != null) {
                                m = +m;
                                isNaN(m) ? m = null : m == Infinity ? m = r : m == -Infinity && (m = -r);
                            }
                            if (m == null) {
                                g.required && (C = !0);
                                g.defaultValue != null && (m = g.defaultValue);
                            }
                        }
                        c[o + a] = m;
                    }
        ...
        function q() {
            var t = a.grid.minBorderMargin, n = {
                x: 0,
                y: 0
            }, r, i;
            if (t == null) {
        ...
        function U(e) {
            ...
            if (i == 0) {
                ...
                if (o != null) {
                    if (t.min == null) {
                        n -= i * o;
                        n < 0 && e.datamin != null && e.datamin >= 0 && (n = 0);
                    }
                    if (t.max == null) {
                        r += i * o;
                        r > 0 && e.datamax != null && e.datamax <= 0 && (r = 0);
                    }
                }
            }
            e.min = n;
        ...
        function z(t) {
            ...
            if (n.alignTicksWithAxis != null) {
                ...
                if (h && h.used && h != t) {
                    ...
                    if (p.length > 0) {
                        n.min == null && (t.min = Math.min(t.min, p[0]));
                        n.max == null && p.length > 1 && (t.max = Math.max(t.max, p[p.length - 1]));
                    }
                    t.tickGenerator = function(e) {
                        var t = [], n, r;
        ...
        function X(e, t) {
            if (e.options.autoscaleMargin && t.length > 0) {
                e.options.min == null && (e.min = Math.min(e.min, t[0].v));
                e.options.max == null && t.length > 1 && (e.max = Math.max(e.max, t[t.length - 1].v));
            }
        }
        function V() {
            f.clear();
        ...
        function Q() {
            ...
            if (s) {
                ...
                for (t = 0; t < s.length; ++t) {
                    ...
                    if (u.from == u.to || f.from == f.to) {
                        ...
                        h.lineWidth = o.lineWidth || a.grid.markingsLineWidth;
                        h.moveTo(u.from, f.from);
                        h.lineTo(u.to, f.to);
                        h.stroke();
                    } else {
            ...
            for (var l = 0; l < n.length; ++l) {
                ...
                if (c.direction == "x") {
                    v = 0;
                    d == "full" ? b = c.position == "top" ? 0 : y : b = p.top - m.top + (c.position == "top" ? p.height : 0);
                } else {
                    b = 0;
                    d == "full" ? v = c.position == "left" ? 0 : g : v = p.left - m.left + (c.position == "left" ? p.width : 0);
                }
                if (!c.innermost) {
                    h.strokeStyle = c.options.color;
                    h.beginPath();
                    E = S = 0;
                    c.direction == "x" ? E = g + 1 : S = y + 1;
                    h.lineWidth == 1 && (c.direction == "x" ? b = Math.floor(b) + .5 : v = Math.floor(v) + .5);
                    h.moveTo(v, b);
                    h.lineTo(v + E, b + S);
                    h.stroke();
                }
            ...
            e.each(k(), function(e, t) {
                ...
                for (var h = 0; h < t.ticks.length; ++h) {
                    ...
                    if (t.direction == "x") {
                        l = "center";
                        u = m.left + t.p2c(o.v);
                        if (t.position == "bottom") a = n.top + n.padding; else {
        ...
        function tt(e, t, n, r, i, s, o, u, a, f, l, c) {
            ...
            if (c > 0 && (m || g || y || b)) {
                f.beginPath();
                f.moveTo(h, d + s);
                m ? f.lineTo(h, v + s) : f.moveTo(h, v + s);
                y ? f.lineTo(p, v + s) : f.moveTo(p, v + s);
                g ? f.lineTo(p, d + s) : f.moveTo(p, d + s);
                b ? f.lineTo(h, d + s) : f.moveTo(h, d + s);
                f.stroke();
            }
        }
        function nt(e) {
            ...
            if (a.legend.container != null) e(a.legend.container).html(p); else {
                ...
                if (a.legend.backgroundOpacity != 0) {
                    ...
                    if (b == null) {
                        ...
                        b && typeof b == "string" ? b = e.color.parse(b) : b = e.color.extract(y, "background-color");
                        b.a = 1;
                        b = b.toString();
                    }
                    var w = y.children();
        ...
        function ct(e, n, r) {
            var i = c.offset(), s = n.pageX - i.left - m.left, o = n.pageY - i.top - m.top, u = L({
                left: s,
                top: o
            });
            u.pageX = n.pageX;
        ...
        function yt(t, n) {
            ...
            p.strokeStyle = r;
            tt(n[0], n[1], n[2] || 0, s, s + t.bars.barWidth, 0, function() {
                return i;
    ...
    n.prototype.getTextLayer = function(t) {
        var n = this.text[t];
        if (n == null) {
            this.textContainer == null && (this.textContainer = e("<div class='flot-text'></div>").css({
                position: "absolute",
                top: 0,
                left: 0,
                bottom: 0,
