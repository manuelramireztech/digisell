...
$.fn.bic_calendar = function(options) {
    ...
    this.each(function(){
        ...
        function mostrarCalendario(){
            ...
            var botonMesSiguiente = $('<td><a href="#" class="botonmessiguiente"><i class="fa fa-arrow-right" ></i></a></td>');
            ...
            var botonMesAnterior = $('<td><a href="#" class="botonmesanterior"><i class="fa fa-arrow-left" ></i></a></td>');
