...
* Copyright 2013 jQuery Foundation and other contributors; Licensed MIT */(function(e, t) {
    function i(t, n) {
        ...
        if ("area" === u) {
            r = t.parentNode;
            i = r.name;
            if (!t.href || !i || r.nodeName.toLowerCase() !== "map") return !1;
            o = e("img[usemap=#" + i + "]")[0];
            return !!o && s(o);
        }
    ...
    e.fn.extend({
        ...
        scrollParent: function() {
            var t;
            e.ui.ie && /(static|relative)/.test(this.css("position")) || /absolute/.test(this.css("position")) ? t = this.parents().filter(function() {
...
(function(e, t) {
    ...
    e.widget = function(t, n, r) {
        ...
        } else n._childConstructors.push(o);
        e.widget.bridge(t, o);
    };
    e.widget.extend = function(n) {
        var i = r.call(arguments, 1), s = 0, o = i.length, u, a;
        for (; s < o; s++) for (u in i[s]) {
            a = i[s][u];
    ...
    e.Widget.prototype = {
        ...
        _trigger: function(t, n, r) {
            ...
            return !(e.isFunction(o) && o.apply(this.element[0], [ n ].concat(r)) === !1 || n.isDefaultPrevented());
        }
    };
    e.each({
        show: "fadeIn",
    ...
    e.ui.position = {
        fit: {
            left: function(e, t) {
                ...
                if (t.collisionWidth > s) if (u > 0 && a <= 0) {
                    f = e.left + u + t.collisionWidth - s - i;
                    e.left += u - f;
                } else a > 0 && u <= 0 ? e.left = i : u > a ? e.left = i + s - t.collisionWidth : e.left = i; else u > 0 ? e.left += u : a > 0 ? e.left -= a : e.left = r(e.left - o, e.left);
            },
            top: function(e, t) {
                var n = t.within, i = n.isWindow ? n.scrollTop : n.offset.top, s = t.within.height, o = e.top - t.collisionPosition.marginTop, u = i - o, a = o + t.collisionHeight - s - i, f;
                if (t.collisionHeight > s) if (u > 0 && a <= 0) {
                    f = e.top + u + t.collisionHeight - s - i;
                    e.top += u - f;
                } else a > 0 && u <= 0 ? e.top = i : u > a ? e.top = i + s - t.collisionHeight : e.top = i; else u > 0 ? e.top += u : a > 0 ? e.top -= a : e.top = r(e.top - o, e.top);
            }
        },
        flip: {
            left: function(e, t) {
...
(function(e, t) {
    e.widget("ui.draggable", e.ui.mouse, {
        ...
        _mouseStop: function(t) {
            ...
            if (this.options.helper === "original" && !e.contains(this.element[0].ownerDocument, this.element[0])) return !1;
            this.options.revert === "invalid" && !r || this.options.revert === "valid" && r || this.options.revert === !0 || e.isFunction(this.options.revert) && this.options.revert.call(this.element, r) ? e(this.helper).animate(this.originalPosition, parseInt(this.options.revertDuration, 10), function() {
        ...
        _createHelper: function(t) {
            ...
            r.parents("body").length || r.appendTo(n.appendTo === "parent" ? this.element[0].parentNode : n.appendTo);
    ...
    e.ui.intersect = function(e, t, r) {
        ...
        switch (r) {
          ...
          case "pointer":
            ...
            return n(s, h, t.proportions.height) && n(i, l, t.proportions.width);
          case "touch":
...
(function(e, t) {
    ...
    e.widget("ui.resizable", e.ui.mouse, {
        ...
        _create: function() {
            ...
            this._handles.mouseover(function() {
                if (!o.resizing) {
                    this.className && (i = this.className.match(/ui-resizable-(se|sw|ne|nw|n|e|s|w)/i));
                    o.axis = i && i[1] ? i[1] : "se";
                }
            });
            if (u.autoHide) {
    ...
    e.ui.plugin.add("resizable", "alsoResize", {
        start: function() {
            ...
            if (typeof n.alsoResize == "object" && !n.alsoResize.parentNode) if (n.alsoResize.length) {
                n.alsoResize = n.alsoResize[0];
                r(n.alsoResize);
            } else e.each(n.alsoResize, function(e) {
                r(e);
            }); else r(n.alsoResize);
        },
        resize: function(t, n) {
        ...
        _mouseDrag: function(t) {
            ...
            this.selectees.each(function() {
                ...
                if (f) {
                    ...
                    if (n.selecting) if ((t.metaKey || t.ctrlKey) && n.startselected) {
                    ...
                    if (n.selected && !t.metaKey && !t.ctrlKey && !n.startselected) {
                        n.$element.removeClass("ui-selected");
                        n.selected = !1;
                        n.$element.addClass("ui-unselecting");
                        n.unselecting = !0;
...
(function(e, t) {
    ...
    e.widget("ui.sortable", e.ui.mouse, {
        ...
        _mouseDrag: function(t) {
            ...
            if (this.options.scroll) {
                if (this.scrollParent[0] !== document && this.scrollParent[0].tagName !== "HTML") {
                    this.overflowOffset.top + this.scrollParent[0].offsetHeight - t.pageY < o.scrollSensitivity ? this.scrollParent[0].scrollTop = u = this.scrollParent[0].scrollTop + o.scrollSpeed : t.pageY - this.overflowOffset.top < o.scrollSensitivity && (this.scrollParent[0].scrollTop = u = this.scrollParent[0].scrollTop - o.scrollSpeed);
                    this.overflowOffset.left + this.scrollParent[0].offsetWidth - t.pageX < o.scrollSensitivity ? this.scrollParent[0].scrollLeft = u = this.scrollParent[0].scrollLeft + o.scrollSpeed : t.pageX - this.overflowOffset.left < o.scrollSensitivity && (this.scrollParent[0].scrollLeft = u = this.scrollParent[0].scrollLeft - o.scrollSpeed);
                } else {
                    t.pageY - e(document).scrollTop() < o.scrollSensitivity ? u = e(document).scrollTop(e(document).scrollTop() - o.scrollSpeed) : e(window).height() - (t.pageY - e(document).scrollTop()) < o.scrollSensitivity && (u = e(document).scrollTop(e(document).scrollTop() + o.scrollSpeed));
            ...
            if (!r.placeholder || r.placeholder.constructor === String) {
                ...
                r.placeholder = {
                    element: function() {
                        ...
                        r === "tr" ? t.currentItem.children().each(function() {
        ...
        _clear: function(e, t) {
            ...
            if (this !== this.currentContainer && !t) {
                r.push(function(e) {
    ...
    e.widget("ui.accordion", {
        ...
        refresh: function() {
            ...
            if (t.active === !1 && t.collapsible === !0 || !this.headers.length) {
                t.active = !1;
                this.active = e();
            } else if (t.active === !1) this._activate(0); else if (this.active.length && !e.contains(this.element[0], this.active[0])) if (this.headers.length === this.headers.find(".ui-state-disabled").length) {
                t.active = !1;
                this.active = e();
            } else this._activate(Math.max(0, t.active - 1)); else t.active = this.headers.index(this.active);
            this._destroyIcons();
            this._refresh();
        },
        ...
        _toggle: function(t) {
            ...
            this.prevShow = n;
            this.prevHide = r;
            if (this.options.animate) this._animate(n, r, t); else {
                r.hide();
                n.show();
        ...
        _animate: function(e, t, n) {
            ...
            e.hide().animate(i, {
                ...
                step: function(e, n) {
                    n.now = Math.round(e);
                    if (n.prop !== "height") f += n.now; else if (a.options.heightStyle !== "content") {
...
(function(e, t) {
    ...
    e.widget("ui.button", {
        ...
        _create: function() {
            ...
            if (this.type === "checkbox") this.buttonElement.bind("click" + this.eventNamespace, function() {
...
(function(e, t) {
    ...
    e.extend(i.prototype, {
        ...
        _attachments: function(t, n) {
            ...
            if (r === "button" || r === "both") {
                ...
                n.trigger.click(function() {
                    if (e.datepicker._datepickerShowing && e.datepicker._lastInput === t[0]) e.datepicker._hideDatepicker(); else if (e.datepicker._datepickerShowing && e.datepicker._lastInput !== t[0]) {
            ...
            if (this._get(e, "autoSize") && !e.inline) {
                ...
                if (o.match(/[DM]/)) {
                    t = function(e) {
                        n = 0;
                        r = 0;
                        for (i = 0; i < e.length; i++) if (e[i].length > n) {
                            n = e[i].length;
                            r = i;
                        }
                        return r;
        ...
        _destroyDatepicker: function(t) {
            ...
            } else (r === "div" || r === "span") && i.removeClass(this.markerClassName).empty();
        },
        ...
        _selectDate: function(t, n) {
            ...
            if (s.inline) this._updateDatepicker(s); else {
            ...
            e.ui.dialog.overlayInstances || this._delay(function() {
                e.ui.dialog.overlayInstances && this.document.bind("focusin.dialog", function(r) {
                    if (!t._allowInteraction(r)) {
                        r.preventDefault();
                        e(".ui-dialog:visible:last .ui-dialog-content").data(n)._focusTabbable();
                    }
                });
            });
    ...
    e.widget("ui.menu", {
            ...
            this._on({
                ...
                "click .ui-menu-item:has(a)": function(t) {
                    ...
                    if (!this.mouseHandled && n.not(".ui-state-disabled").length) {
                        this.mouseHandled = !0;
                        this.select(t);
                        if (n.has(".ui-menu").length) this.expand(t); else if (!this.element.is(":focus")) {
        ...
        nextPage: function(t) {
            ...
            if (this._hasScroll()) {
                ...
                this.focus(t, n);
            } else this.focus(t, this.activeMenu.children(".ui-menu-item")[this.active ? "last" : "first"]());
        },
    ...
    e.widget("ui.progressbar", {
        ...
        _refreshValue: function() {
            ...
            if (this.indeterminate) {
                ...
                this.overlayDiv || (this.overlayDiv = e("<div class='ui-progressbar-overlay'></div>").appendTo(this.valueDiv));
            } else {
                this.element.attr({
...
(function(e, t) {
    ...
    e.widget("ui.slider", e.ui.mouse, {
        ...
        _createRange: function() {
            ...
            if (t.range) {
                t.range === !0 && (t.values ? t.values.length && t.values.length !== 2 ? t.values = [ t.values[0], t.values[0] ] : e.isArray(t.values) && (t.values = t.values.slice(0)) : t.values = [ this._valueMin(), this._valueMin() ]);
        ...
        _setOption: function(t, n) {
            var r, i = 0;
            if (t === "range" && this.options.range === !0) if (n === "min") {
        ...
        _refreshValue: function() {
            ...
            if (this.options.values && this.options.values.length) this.handles.each(function(r) {
                ...
                if (a.options.range === !0) if (a.orientation === "horizontal") {
...
(function(e) {
    ...
    e.widget("ui.spinner", {
        ...
        _precision: function() {
            ...
            this.options.min !== null && (e = Math.max(e, this._precisionOf(this.options.min)));
            return e;
        },
        ...
        _adjustValue: function(e) {
            ...
            return r.max !== null && e > r.max ? r.max : r.min !== null && e < r.min ? r.min : e;
        },
        _stop: function(e) {
        ...
        _parse: function(e) {
            typeof e == "string" && e !== "" && (e = window.Globalize && this.options.numberFormat ? Globalize.parseFloat(e, 10, this.options.culture) : +e);
...
(function(e, t) {
    ...
    e.widget("ui.tabs", {
        ...
        refresh: function() {
            ...
            this._processTabs();
            if (t.active === !1 || !this.anchors.length) {
                t.active = !1;
                this.active = e();
            } else if (this.active.length && !e.contains(this.tablist[0], this.active[0])) if (this.tabs.length === t.disabled.length) {
                t.active = !1;
                this.active = e();
            } else this._activate(this._findNextTab(Math.max(0, t.active - 1), !1)); else t.active = this.tabs.index(this.active);
            this._refresh();
        },
        _refresh: function() {
        ...
        _toggle: function(t, n) {
            ...
            function u() {
                ...
                if (i.length && r.options.show) r._show(i, r.options.show, o); else {
                    i.show();
                    o();
                }
            }
        ...
        _getIndex: function(e) {
            typeof e == "string" && (e = this.anchors.index(this.anchors.filter("[href$='" + e + "']")));
            return e;
        },
        _destroy: function() {
            this.xhr && this.xhr.abort();
...
(function(e, t) {
    ...
    (function(e, t) {
        function h(e, t, n) {
            var r = u[t.type] || {};
            if (e == null) return n || !t.def ? null : t.def;
            e = r.floor ? ~~e : parseFloat(e);
            return isNaN(e) ? t.def : r.mod ? (e + r.mod) % r.mod : 0 > e ? 0 : r.max < e ? r.max : e;
        }
        function p(t) {
            var n = s(), r = n._rgba = [];
            t = t.toLowerCase();
            ...
            if (r.length) {
                r.join() === "0,0,0,0" && e.extend(r, l.transparent);
                return n;
            }
            return l[t];
        }
        ...
        s.fn = e.extend(s.prototype, {
            parse: function(n, r, i, u) {
                ...
                if (f === "object") {
                    n instanceof s ? c(o, function(e, t) {
            ...
            transition: function(e, t) {
                ...
                c(i.props, function(e, r) {
                    ...
                    if (o === null) return;
                    if (s === null) l[i] = o; else {
                        a.mod && (o - s > a.mod / 2 ? s += a.mod : s - o > a.mod / 2 && (s -= a.mod));
                        l[i] = h((o - s) * t + s, r);
                    }
                });
                return this[r](l);
    ...
    (function() {
        ...
        e.extend(e.effects, {
            ...
            restore: function(e, r) {
                var i, s;
                for (s = 0; s < r.length; s++) if (r[s] !== null) {
                    i = e.data(n + r[s]);
                    i === t && (i = "");
                    e.css(r[s], i);
                }
            ...
            setMode: function(e, t) {
                t === "toggle" && (t = e.is(":hidden") ? "show" : "hide");
                return t;
            },
...
(function(e, t) {
    ...
    e.effects.effect.size = function(t, n) {
        ...
        if (v === "content" || v === "both") if (s.from.y !== s.to.y) {
